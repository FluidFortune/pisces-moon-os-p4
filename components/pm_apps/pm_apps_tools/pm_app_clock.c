...
// static lv_obj_t* s_lbl_time   = NULL;  // duplicate of void* declaration above
// static lv_obj_t* s_lbl_date   = NULL;  // duplicate of void* declaration above
// static lv_obj_t* s_lbl_status = NULL;  // duplicate of void* declaration above
